...
/*[Kallol] : 
 * Tag Name : DNP , dynamic network provisioning
 * Revision History:
 * [03-10-2013]
 * Goal : Netback will do its communication through a VF. Bridge will not be 
 *      used but its code will be kept and will not be traversed. 
 */
#if 0
struct backend_info {
	struct xenbus_device *dev;
	struct xenvif *vif;
        int unique_netback_id;   //this will be unique number for every netback .. have use to identify the netback from VFs end
			 ...
			 const struct xenbus_device_id *id)
{
	...
	backend_create_xenvif(be); 
        //[DNP initial assignment changes are now kept inside connect() method]
	return 0;
